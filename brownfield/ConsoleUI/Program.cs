...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var timedWorked = TimeSheetProcessor.CalculateTimeWorked(timeSheetEntries);

            foreach (var paymentModel in payments)
            {
                if (timedWorked > paymentModel.HourLimit)
                {
                    SimulatePayment(paymentModel, timedWorked);
                    break;
                }
            }
        ...
        static List<TimeSheetEntryModel> GetTimeSheetEntries()
        {
            ...
            do
            {
                Console.Write("Enter what you did for customer: ");
                ...
                // Dirty continueEntering = Console.ReadLine().ToLower() == "yes";
            }
        ...
        static void SimulatePayment(PaymentModel paymentModel, int hours)
        {
            ...
            Console.WriteLine($"You will get paid paid ${amountToPay} for your {paymentModel.Label}");
        }
